<div class="barangays index">
	<h2><?php __('Barangays');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $barangay['Barangay']['id']; ?>&nbsp;</td>
		<td><?php echo $barangay['Barangay']['name']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($barangay['Municipality']['name'], array('controller' => 'municipalities', 'action' => 'view', $barangay['Municipality']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $barangay['Barangay']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $barangay['Barangay']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $barangay['Barangay']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $barangay['Barangay']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
